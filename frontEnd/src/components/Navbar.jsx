...
export default function Navbar() {
  ...
  return (
    ...
    ${
      isHomePage
        ? "absolute top-0 left-0 text-white bg-none hover:bg-white hover:text-black z-70 w-full"
        : ""
    }
    `}
      >
        ...
        >
          ...
          {showMenu && (
            <ul
              className={`fixed top-0 left-0 w-[25rem] h-full bg-white z-80 flex flex-col items-start pt-25 pl-5 gap-2 text-black text-light transition-all font-light`}
            >
