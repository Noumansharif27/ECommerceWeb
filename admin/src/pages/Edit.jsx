      ...
      <div className="max-w-5xl mx-auto">
        ...
        <header className="mb-8 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link
              to="/list"
              className="p-2 bg-white border rounded-lg hover:bg-gray-100 transition-all shadow-sm text-gray-600"
            >
              <ArrowLeft size={20} />
            </Link>
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Edit Product</h1>
              <p className="text-gray-500 text-sm font-mono">ID: {productId}</p>
            </div>
          </div>
        </header>
          ...
          <div className="space-y-6">
            ...
            >
              {isUploading ? (
                ...
                <>
                  <CheckCircle2 size={20} /> Update Product
                </>
              )}
            </button>
          </div>
